...
<html lang="en">
  ...
  <link rel="icon" href="https://fonts.gstatic.com/s/i/materialicons/school/v6/24px.svg" type="image/svg+xml">
	<title>SMP 3 Muhammadiyah | Edit Jadwal Untuk Guru/Siswa</title>
			...
			<div class="">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 ">
						<div class="x_panel">
							<div class="x_title">
								<h2>Edit Jadwal Untuk Guru/Siswa<small>pada form di bawah ini</small></h2>
							...
							<div class="x_content">
								...
								<form action="{{ route('dashboard.each_schedule.update', $eachSchedule->id) }}" method="POST">
                  @csrf
                  @method('PUT')
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6">
                          <select name="user_id" id="email" required="required" class="form-control">
                              <option value="">Pilih Email Baru</option>
                              @foreach($users as $u)
                                  <option value="{{ $u->id }}" {{ $u->id == $eachSchedule->user_id ? 'selected' : '' }}>
                                      {{ $u->email }}
                                  </option>
                              @endforeach
                      ...
                      <div class="col-md-6 col-sm-6">
                          <select name="user_schedule_id" id="user_schedule_id" required="required" class="form-control">
                              ...
                              @foreach($schedules as $schedule)
                                  <option value="{{ $schedule->id }}" {{ $schedule->id == $eachSchedule->user_schedule_id ? 'selected' : '' }}>
