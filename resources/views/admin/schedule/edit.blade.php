...
<html lang="en">
  ...
  <link rel="icon" href="https://fonts.gstatic.com/s/i/materialicons/school/v6/24px.svg" type="image/svg+xml">
	<title>SMP 3 Muhammadiyah | Edit Jadwal Pelajaran</title>
			...
			<div class="">
				<div class="page-title">
					<div class="title_left">
						<h3>Edit Jadwal Untuk Guru/Siswa</h3>
					</div>
				</div>
				<div class="clearfix"></div>
				<div class="row">
					<div class="col-md-12 col-sm-12 ">
						<div class="x_panel">
							<div class="x_title">
								<h2>Edit Jadwal Untuk Guru/Siswa <small>pada form di bawah</small></h2>
							...
							<div class="x_content">
								...
								<form action="{{ route('dashboard.schedule.update', $schedule->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input type="datetime-local" name="start_time" id="start_time" class="form-control" value="{{ old('start_time', $schedule->start_time) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input type="datetime-local" name="end_time" id="end_time" class="form-control" value="{{ old('start_time', $schedule->end_time) }}" required>
                                        </div>
                                    </div>
