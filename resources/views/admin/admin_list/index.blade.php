                      ...
                      <div class="row">
                          <div class="col-sm-12">
                            <div class="card-box table-responsive">
                              <form action="{{ route('dashboard.admin_list.create') }}" method="GET" style="display:inline;">
                                  ...
                                  @foreach($admins as $key => $admin)
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <form action="{{ route('dashboard.admin_list.reset_password', $admin->id) }}" method="GET">
                                            @csrf
                                      ...
                                      <td style="display: flex; align-items: center;">
                                        <form action="{{ route('dashboard.admin_list.edit', $admin->id) }}" method="GET" style="display: inline-block;">
