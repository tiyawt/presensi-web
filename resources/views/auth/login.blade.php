...
<head>
   ...
   <style>
      .footer {
         ...
         right: 0;
         width: 100%;
         /* Pastikan footer selebar layar */
         height: 50px;
         /* Atur tinggi footer sesuai kebutuhan */
         padding: 10px;
         background-color: #f5f5f5;
         /* Warna latar belakang footer */
         z-index: 1000;
         /* Pastikan footer berada di atas elemen lain */
      }
      ...
      body {
         ...
         /* Hapus margin body */
         padding-bottom: 60px;
         /* Tambahkan padding bawah agar konten tidak tertutup oleh footer */
      }
   ...
   <script nonce="215bc572-2e29-49ff-b54b-9a188732dd3e">
      try {
         (function(w, d) {
            ! function(j, k, l, m) {
