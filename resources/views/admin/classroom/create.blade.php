...
<head>
  ...
  <title>SMP 3 Muhammadiyah | Tambah Kelas</title>
        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Buat Kelas Baru <small>pada form di bawah</small></h2>
                ...
                <div class="x_content">
                  ...
                  <form action="{{ route('dashboard.classroom.store') }}" method="POST">
                    ...
                    <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align" for="classroom_name">Nama Kelas <span class="required">*</span></label>
