...
<html lang="en">
  ...
  <link rel="icon" href="https://fonts.gstatic.com/s/i/materialicons/school/v6/24px.svg" type="image/svg+xml">
	<title>SMP 3 Muhammadiyah | Edit Guru</title>
			...
			<div class="">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 ">
						<div class="x_panel">
							<div class="x_title">
								<h2>Edit Guru <small>pada form di bawah</small></h2>
							...
							<div class="x_content">
								...
								<form action="{{ route('dashboard.teacher_list.update', $teacher->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
