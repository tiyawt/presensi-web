...
<html lang="en">
  ...
  <link rel="icon" href="https://fonts.gstatic.com/s/i/materialicons/school/v6/24px.svg" type="image/svg+xml">
	<title>SMP 3 Muhammadiyah | Edit Kelas</title>
			...
			<div class="">
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 ">
						<div class="x_panel">
							<div class="x_title">
								<h2>Edit Kelas <small>pada form di bawah</small></h2>
							...
							<div class="x_content">
								...
								<form action="{{ route('dashboard.classroom.update', $classroom->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="classroom_name">Nama Kelas Baru <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6">
                                            <input type="text" name="classroom_name" id="classroom_name" class="form-control" value="{{ old('classroom_name', $classroom->name) }}" required>
                                        </div>
                                    </div>
